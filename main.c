...
int	main(int ac, char **av)
{
	...
	if (ac == 2)
	{
		...
		vars->objects[0] = new_sphere(vector( 0, -1, 3), 2.0f, 0xFF0000);
		vars->objects[1] = new_sphere(vector( 2, 0, 4), 2.0f, 0x0000FF);
		vars->objects[2] = new_sphere(vector(-2, 0, 4), 2.0f, 0x00FF00);
		vars->objects[3] = new_sphere(vector(0, -5001, 0), 10000.0f, 0xFFFF00);
		//light
