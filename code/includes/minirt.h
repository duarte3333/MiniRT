...
/*   Updated: 2023/10/12 21:27:30 by duarte33         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float		check_width(t_plane *this, t_raytracer *rt, \
	float t, float diameter);
void		create_upper_cap(t_cylinder *cylinder);
void		create_lower_cap(t_cylinder *cylinder);
t_values	rest_intersect(t_raytracer *rt, t_cylinder *this, \
	t_values local);
